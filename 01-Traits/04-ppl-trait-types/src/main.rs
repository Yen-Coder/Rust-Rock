/**
 * This code is from Ben Herzog's GitHub Repo:
 * https://github.com/BenH11235/rust-re-tour/blob/main/0_basic_pl_concepts/src/main.rs
 * 
 * His amazing article about RE Rust binaries:
